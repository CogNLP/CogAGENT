...
from ..personality_captions.transresnet.transresnet import TransresnetAgent
...
class TransresnetMultimodalAgent(TransresnetAgent):
    ...
    def _setup_cands(self):
        ...
        if self.fcp is not None:
            with ic.PathManager.open(self.fcp, encoding='utf-8') as f:
    ...
    def observe(self, observation):
        ...
        """
        observation = ic.Message(observation)  # TODO: eventually this will not be
    ...
    def report(self):
        ...
        for k, v in self.metrics.items():
            ...
            if v["num_samples"] > 0:
                m[f"{k}/hits@1/100"] = ic.round_sigfigs(
                    v["hits@1/100"] / v["num_samples"], 4
                )
                m[f"{k}/loss"] = ic.round_sigfigs(v["loss"] / v["num_samples"], 4)
                if "med_rank" in v:
