...
from core.agents import create_agents_from_shared
from core.loader import load_task_module, load_world_module
...
from core.teachers import Teacher, create_task_agent_from_taskname
from utils.data import DatatypeHelper
from utils.misc import Timer, display_messages, warn_once
from projects.image_chat import image_chat as ic
# from tasks.tasks import ids_to_tasks
from utils.misc import error_once
...
def create_task(opt: Opt, user_agents, default_world=None):
    ...
    opt = copy.deepcopy(opt)
    opt['task'] = ic.ids_to_tasks(opt['task'])
