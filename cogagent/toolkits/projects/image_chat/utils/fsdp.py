...
import torch.nn
from scripts.eval_model import Evaluator
from scripts.train_model import TrainLoop
from utils.distributed import is_distributed, get_dist_group
...
def maybe_fsdp_wrap(opt):
    ...
    if 'hugging_face' not in opt['model']:
        from agents.transformer.modules.encoder import (
            TransformerEncoderLayer,
        )
        from agents.transformer.modules.decoder import (
