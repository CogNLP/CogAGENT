...
def load_agent_module(agent_path: str):
    ...
    * half-shorthand: ``-m seq2seq/variant``, which will check the path
    ...
    if agent_path.startswith('projects:'):
        ...
        path_list = agent_path.split('/')
        module_name = "projects.image_chat.%s.agents.%s.%s" % (repo, path_list[0], path_list[1])
        ...
        try:
            module_name = "projects.image_chat.%s.agents.%s.agents" % (repo, agent_path)
            importlib.import_module(module_name)  # check if it's there
        except ImportError:
            module_name = "projects.image_chat.%s.agents.%s.%s" % (repo, agent_path, agent_path)
...
def load_task_module(taskname: str):
    ...
    if '.' in task_path:
        ...
        module_name = "projects.image_chat.%s.tasks.%s.agents" % (repo, task)
        # module_name = "projects.image_chat.%s.agents" %task
        module_name = "projects.image_chat.%s.agents" %task
...
def setup_interactive():
    ...
    opt["model_file"] = "/data/zhaojingxuan/zjxcode/CogAgent/cogagent/toolkits/projects/image_chat/transresnet_multimodal/model/model"
...
if __name__ == "__main__":
    # setup_interactive()
    # img = Image.open("/data/zhaojingxuan/zjxcode/CogAgent/cogagent/toolkits/projects/image_chat/dog.jpg") 
    # path = "/data/zhaojingxuan/zjxcode/CogAgent/cogagent/toolkits/projects/image_chat/dog.jpg"
    ...
    #     print("==" * 30)
    #     print()
    res =  inference(e_image='data:image/jpg;base64,',personality='Adventurous',text='what is it')
    # print("问题:", input_text)
    print("答案:", res['text'])
    print("==" * 30)
    print()
