...
class BertAttention(nn.Module):
    ...
    def forward(
        ...
        self_outputs = self.self(
            ...
            output_attentions,
            per_hidden_states=per_hidden_states,
        )
...
class BertLayer(nn.Module):
    def __init__(self, config):
        ...
        self.is_decoder2 = config.is_decoder2
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        per_embedding_output = self.embeddings(
            input_ids=per_input_ids, position_ids=None, token_type_ids=None, inputs_embeds=None
        ) if per_input_ids is not None else None
        ...
        encoder_outputs = self.encoder(
            ...
            per_hidden_states=per_embedding_output,
        )
...
class BertLMHeadModel(BertPreTrainedModel):
    ...
    def prepare_inputs_for_generation(self, input_ids, attention_mask=None, per_input_ids=None, **model_kwargs):
        ...
        return {"input_ids": input_ids, "attention_mask": attention_mask, "per_input_ids": per_input_ids,}
